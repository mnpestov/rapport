...
import {
  submitBotAuthorApplication,
  getBotApplicationStatus,
  respondToApplication,
  reserveApplicationLogin,
...
router.post('/bot/author-application/reserve-login', requireBotApiKey, reserveApplicationLogin);
router.post('/bot/author-application/discard-draft', requireBotApiKey, discardApplicationDraft);
